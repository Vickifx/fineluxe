...
const HeroBanner = () => {
  return (
    <div className="relative overflow-hidden bg-navy h-[80vh] flex items-center">
      ...
      <div className="container-padding mx-auto relative z-10 text-white">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="font-playfair text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight">
            Luxury <span className="text-gold">Jewelry</span> for Every Occasion
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link to="/about" className="border border-white text-white hover:bg-white hover:text-navy px-8 py-3 rounded-md transition-colors text-lg">
              Our Story
            </Link>
          </div>
        </div>
