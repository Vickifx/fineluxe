...
const About = () => {
  return (
    <>
      <div className="relative bg-brown h-64 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center">
          ...
          <nav className="flex justify-center text-sm">
            <Link to="/" className="text-nude-300 hover:text-white transition-colors">Home</Link>
      ...
      <section className="py-16 container-padding mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl font-playfair font-medium text-brown mb-6">About Fineluxe</h2>
        ...
        <div className="container-padding mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              <div className="w-16 h-16 rounded-full bg-nude-100 flex items-center justify-center mx-auto mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#8B6E4E" className="w-8 h-8">
              ...
              <h3 className="text-xl font-medium text-brown mb-3">Craftsmanship</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-medium text-brown mb-3">Ethical Sourcing</h3>
              <p className="text-brown-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-xl font-medium text-brown mb-3">Timeless Design</h3>
              <p className="text-brown-600">
